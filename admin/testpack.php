...
<div class="form-container contain" style="margin-top:20px;">
	<form name="bulk_action_form" action="del_tpack.php" method="post" onsubmit="return deleteConfirm();"/>
	<table class="w3-table-all w3-hoverable">
		...
		<thead>
			...
			<?php
				...
				$quer = mysqli_query($conn, "SELECT * FROM tpack ORDER BY id DESC LIMIT $start_from, $results_per_page");
				echo mysqli_error($conn);
				while($res = mysqli_fetch_array($quer)){


					echo "<tr>";
					echo "<td>".$res['pack_name']."</td>";
					echo "<td>".$res['subject']."</td>";
					echo "<td>".$res['grade']."</td>";
					echo "<td>".$res['syllabus']."</td>";
					
					
					echo "<td><a href=\"edit_tpack.php?id=$res[id]\">Edit</a> </td>";
